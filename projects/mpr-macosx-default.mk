...
$(CONFIG)/bin/libmpr.dylib: $(DEPS_53)
	@echo '      [Link] libmpr'
...
$(CONFIG)/bin/benchMpr: $(DEPS_55)
	@echo '      [Link] benchMpr'
	$(CC) -o $(CONFIG)/bin/benchMpr -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/benchMpr.o $(LIBS_55) $(LIBS_55) $(LIBS)
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_64)
	@echo '      [Link] libmprssl'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib $(LDFLAGS) -compatibility_version 4.3.0 -current_version 4.3.0 $(LIBPATHS) -install_name @rpath/libmprssl.dylib $(CONFIG)/obj/est.o $(CONFIG)/obj/matrixssl.o $(CONFIG)/obj/nanossl.o $(CONFIG)/obj/openssl.o $(CONFIG)/obj/ssl.o $(LIBS_64) $(LIBS_64) $(LIBS) -lest
...
DEPS_82 += $(CONFIG)/bin/libmprssl.dylib
...
$(CONFIG)/bin/manager: $(DEPS_83)
	@echo '      [Link] manager'
	$(CC) -o $(CONFIG)/bin/manager -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/manager.o $(LIBS_83) $(LIBS_83) $(LIBS)
...
$(CONFIG)/bin/makerom: $(DEPS_85)
	@echo '      [Link] makerom'
	$(CC) -o $(CONFIG)/bin/makerom -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/makerom.o $(LIBS_85) $(LIBS_85) $(LIBS)
...
$(CONFIG)/bin/chargen: $(DEPS_87)
	@echo '      [Link] chargen'
	$(CC) -o $(CONFIG)/bin/chargen -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/charGen.o $(LIBS_87) $(LIBS_87) $(LIBS)
