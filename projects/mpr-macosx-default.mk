...
#
ifeq ($(BIT_PACK_EST),1)
    DEPS_75 += $(CONFIG)/bin/libest.dylib
endif
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_82)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmprssl.dylib -compatibility_version 4.3.0 -current_version 4.3.0 $(CONFIG)/obj/est.o $(CONFIG)/obj/matrixssl.o $(CONFIG)/obj/nanossl.o $(CONFIG)/obj/openssl.o $(CONFIG)/obj/ssl.o $(LIBPATHS_82) $(LIBS_82) $(LIBS_82) $(LIBS) 
...
$(CONFIG)/bin/manager: $(DEPS_84)
	...
	$(CC) -o $(CONFIG)/bin/manager -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/manager.o $(LIBPATHS_84) $(LIBS_84) $(LIBS_84) $(LIBS) 
...
$(CONFIG)/bin/makerom: $(DEPS_86)
	...
	$(CC) -o $(CONFIG)/bin/makerom -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/makerom.o $(LIBPATHS_86) $(LIBS_86) $(LIBS_86) $(LIBS) 
...
$(CONFIG)/bin/chargen: $(DEPS_88)
	...
	$(CC) -o $(CONFIG)/bin/chargen -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/charGen.o $(LIBPATHS_88) $(LIBS_88) $(LIBS_88) $(LIBS) 
