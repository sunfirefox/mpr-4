...
"${CC}" -c -Fo${CONFIG}\obj\mprMatrixssl.obj -Fd${CONFIG}\obj\mprMatrixssl.pdb ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc -I../packages-windows-x86/openssl/openssl-1.0.1b/inc32 src/mprMatrixssl.c

"${CC}" -c -Fo${CONFIG}\obj\mprOpenssl.obj -Fd${CONFIG}\obj\mprOpenssl.pdb ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc -I../packages-windows-x86/openssl/openssl-1.0.1b/inc32 src/mprOpenssl.c

"${CC}" -c -Fo${CONFIG}\obj\mprSsl.obj -Fd${CONFIG}\obj\mprSsl.pdb ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc -I../packages-windows-x86/openssl/openssl-1.0.1b/inc32 src/mprSsl.c

"${LD}" -dll -out:${CONFIG}\bin\libmprssl.dll -entry:_DllMainCRTStartup@12 -def:${CONFIG}\bin\libmprssl.def ${LDFLAGS} ${LIBPATHS} -libpath:../packages-windows-x86/openssl/openssl-1.0.1b/out32dll ${CONFIG}\obj\mprMatrixssl.obj ${CONFIG}\obj\mprOpenssl.obj ${CONFIG}\obj\mprSsl.obj libmpr.lib ${LIBS} libeay32.lib ssleay32.lib
