#
#   mpr-windows-default.sh -- Build It Shell Script to build Multithreaded Portable Runtime
#
...
"${LD}" -dll -out:${CONFIG}/bin/libmprssl.dll -entry:_DllMainCRTStartup@12 ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/est.obj ${CONFIG}/obj/matrixssl.obj ${CONFIG}/obj/mocana.obj ${CONFIG}/obj/openssl.obj ${CONFIG}/obj/ssl.obj libmpr.lib ${LIBS} libest.lib
