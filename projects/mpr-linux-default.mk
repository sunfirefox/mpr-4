...
$(CONFIG)/bin/benchMpr: $(DEPS_54)
	@echo '      [Link] benchMpr'
	$(CC) -o $(CONFIG)/bin/benchMpr $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/benchMpr.o $(LIBPATHS_54) $(LIBS_54) $(LIBS_54) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_62)
	@echo '      [Link] libmprssl'
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/est.o $(CONFIG)/obj/matrixssl.o $(CONFIG)/obj/nanossl.o $(CONFIG)/obj/openssl.o $(CONFIG)/obj/ssl.o $(LIBPATHS_62) $(LIBS_62) $(LIBS_62) $(LIBS) 
