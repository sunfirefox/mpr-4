...
$(CONFIG)/bin/manager.out: $(DEPS_81)
	...
	$(CC) -o $(CONFIG)/bin/manager.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/manager.o" $(LIBPATHS_81) $(LIBS_81) $(LIBS_81) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/makerom.out: $(DEPS_83)
	...
	$(CC) -o $(CONFIG)/bin/makerom.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/makerom.o" $(LIBPATHS_83) $(LIBS_83) $(LIBS_83) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/chargen.out: $(DEPS_85)
	...
	$(CC) -o $(CONFIG)/bin/chargen.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/charGen.o" $(LIBPATHS_85) $(LIBS_85) $(LIBS_85) $(LIBS) -Wl,-r 
