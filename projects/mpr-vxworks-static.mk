...
$(CONFIG)/bin/manager.out: $(DEPS_84)
	@echo '      [Link] $(CONFIG)/bin/manager.out'
	$(CC) -o $(CONFIG)/bin/manager.out $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/manager.o $(LIBPATHS_84) $(LIBS_84) $(LIBS_84) $(LIBS) $(LDFLAGS) 
...
$(CONFIG)/bin/makerom.out: $(DEPS_86)
	@echo '      [Link] $(CONFIG)/bin/makerom.out'
	$(CC) -o $(CONFIG)/bin/makerom.out $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/makerom.o $(LIBPATHS_86) $(LIBS_86) $(LIBS_86) $(LIBS) $(LDFLAGS) 
...
$(CONFIG)/bin/chargen.out: $(DEPS_88)
	@echo '      [Link] $(CONFIG)/bin/chargen.out'
	$(CC) -o $(CONFIG)/bin/chargen.out $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/charGen.o $(LIBPATHS_88) $(LIBS_88) $(LIBS_88) $(LIBS) $(LDFLAGS) 
