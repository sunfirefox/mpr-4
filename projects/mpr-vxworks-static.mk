...
$(CONFIG)/bin/benchMpr.out: $(DEPS_54)
	@echo '      [Link] benchMpr'
	$(CC) -o $(CONFIG)/bin/benchMpr.out $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/benchMpr.o $(LDFLAGS)  $(LIBS_54) $(LIBS_54)
