#
#   mpr-windows-static.sh -- Build It Shell Script to build Multithreaded Portable Runtime
#
...
"${CC}" -c -Fo${CONFIG}/obj/mocana.obj -Fd${CONFIG}/obj/mocana.pdb ${CFLAGS} ${DFLAGS} -I${CONFIG}/inc -Isrc/deps/est src/ssl/mocana.c

"${CC}" -c -Fo${CONFIG}/obj/openssl.obj -Fd${CONFIG}/obj/openssl.pdb ${CFLAGS} ${DFLAGS} -I${CONFIG}/inc -Isrc/deps/est src/ssl/openssl.c

"${CC}" -c -Fo${CONFIG}/obj/ssl.obj -Fd${CONFIG}/obj/ssl.pdb ${CFLAGS} ${DFLAGS} -I${CONFIG}/inc -Isrc/deps/est src/ssl/ssl.c

"lib.exe" -nologo -out:${CONFIG}/bin/libmprssl.lib ${CONFIG}/obj/est.obj ${CONFIG}/obj/matrixssl.obj ${CONFIG}/obj/mocana.obj ${CONFIG}/obj/openssl.obj ${CONFIG}/obj/ssl.obj
